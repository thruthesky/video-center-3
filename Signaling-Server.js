...
module.exports = exports = function(app, videoCenter, socketCallback)  {
    var listOfUsers = {};
    ...
    videoCenter.io = io; // 이 코드를 여기에 두어야 에러가 나지 않는다.
    ...
    function onConnection(socket) {
        ...
        socket.on('get-user-connection-list', function(callback) {
